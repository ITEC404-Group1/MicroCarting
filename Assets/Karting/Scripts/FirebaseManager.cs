...
namespace Model
{
    public class FirebaseManager : MonoBehaviour
    {
        ...
        public IEnumerator SaveScore(bool _won, int _pos, string _mapName, int _xp)
        {
            ...
            var DBTask = DBreference.Child("scores").Child(UserId).Push().SetRawJsonValueAsync(json);
        ...
        {
            var DBTask = DBreference.Child("scores").Child(UserId).GetValueAsync();
            yield return new WaitUntil(predicate: () => DBTask.IsCompleted);
